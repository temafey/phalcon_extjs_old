Ext.define('Cms.TabPanel', {
     ...
     * @param {String} controller The url of the grid
     */
     ...
     * @private
     * @param {Cms.WindowPost} post The post
     * @param {Ext.data.Model} rec The model
     */
     ...
     * @private
     * @param {Cms.WindowDetail} info The detail
     * @param {Ext.data.Model} rec The model
     */
